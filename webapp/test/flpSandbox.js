		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Routing in Fiori",
									"targetURL": "#routingzrouting-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"routingzrouting-display": {
								"semanticObject": "routingzrouting",
								"action": "display",
								"description": "A Routing Fiori application.",
								"title": "Routing in Fiori",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=routing.zrouting",
									"url": sap.ui.require.toUrl("routing/zrouting")
								}
							}
						}
					}
